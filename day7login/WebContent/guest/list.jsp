...
<%@ page language="java" contentType="text/html; charset=EUC-KR"
    pageEncoding="EUC-KR" import ="java.sql.*,com.hb.*,java.util.ArrayList"%>
...
%>
	...
	<tr>
		<td><%=bean.getSabun() %></td>
		<td><a href = "/day7login/index.jsp?template=detail&sabun=<%=bean.getSabun()%>"><%=bean.getName() %></a></td>
		<td><%=bean.getNalja() %></td>
		<td><%=bean.getPay() %></td>
	</tr>
	<%} %>
	</table>
	<a href = "index.jsp?template=add">추가</a>
</body>
</html>